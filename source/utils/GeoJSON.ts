...
var GeoJSON = ( function() 
{
     ...
     */
	var collectFeatures = function( data, layers, _topojson ): any
	{
     ...
     */
	var lineStringAttributes = function( coordinates, colour, height ): any
	{
     ...
     * update GeoJSONTile to use the new GeoJSONLayer or geometry layers.
     */
	var multiLineStringAttributes = function( coordinates, colour, height ): any
	{
     ...
     * update GeoJSONTile to use the new GeoJSONLayer or geometry layers.
     */
	var polygonAttributes = function( coordinates, colour, height ): any
	{
     ...
     * update GeoJSONTile to use the new GeoJSONLayer or geometry layers.
     */
	var _toEarcut = function( data ): any
	{
     ...
     * update GeoJSONTile to use the new GeoJSONLayer or geometry layers.
     */
	var _triangulate = function( contour, holes, dim ): any
	{
